  ...
  _createClass(Rest, [{
    ...
    value: function upload(formData, headers) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        (0, _isomorphicFetch.default)(url, enveloppe).then(function (response) {
    ...
    value: function _call(url, enveloppe, queryParams) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        (0, _debug.default)("Calling URL '".concat(url, "'"));
        (0, _isomorphicFetch.default)(url, enveloppe).then(checkStatus(_this._silent)).then(function (response) {
          resolve(response.json());
        }).catch(function (err) {
          (0, _debug.default)('Failed with error', err);
          reject(err);
