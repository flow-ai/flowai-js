...
var FileAttachment = exports.FileAttachment = function (_Attachment) {
  ...
  function FileAttachment(data) {
    ...
    if (typeof window !== 'undefined' && !(data instanceof _formData2.default)) {
      throw new _exception2.default('FileAttachment requires a FormData not ' + (typeof data === 'undefined' ? 'undefined' : _typeof(data)), 'user');
    } else {
