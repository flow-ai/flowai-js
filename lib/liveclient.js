...
var LiveClient = function (_EventEmitter) {
  ...
  _createClass(LiveClient, [{
    ...
    value: function history(threadId) {
      ...
      if (!threadId && !_unique2.default.exists(this._clientId, 'threadId')) {
        return this.emit(LiveClient.NO_HISTORY);
      }

      this.threadId = new _unique2.default(this._clientId, 'threadId', threadId);
      this.sessionId = new _unique2.default(this._clientId, 'sessionId', threadId);
