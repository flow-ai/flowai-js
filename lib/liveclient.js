 ...
 * })
 **/
var LiveClient = /*#__PURE__*/function (_EventEmitter) {
  _inherits(LiveClient, _EventEmitter);
  var _super = _createSuper(LiveClient);
  /**
   * Constructor
   * @constructor
  ...
  function LiveClient(opts) {
    ...
    _this._init();
    (0, _debug.default)('Constructed a new LiveClient', _assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(LiveClient, [{
    ...
    set: function set(value) {
      ...
      this.log("Setting threadId=".concat(value));
      // Create a new Thread
    ...
    value: function start(threadId, sessionId) {
      try {
        ...
        (0, _debug.default)("Starting the client with sessionId ".concat(sessionId, " and threadId '").concat(threadId, "'"));
    ...
    value: function _handleConnection(payload) {
      ...
      socket.onopen = function () {
        ...
        _this11.emit(LiveClient.CONNECTED);

        // Clear any running interval
        clearInterval(_this11._keepAliveInterval);
      ...
      socket.onmessage = function (evt) {
        ...
        switch (type) {
          ...
          case 'activities.created':
            _this11.log("[ACK] Message received: ".concat(evt.data));
