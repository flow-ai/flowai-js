...
function (_EventEmitter) {
  ...
  _createClass(LiveClient, [{
    ...
    get: function get() {
      ...
      this.log("Getting threadId. threadId=".concat(threadId, ", this.threadId=").concat(this.threadId));
    ...
    set: function set(value) {
      ...
      this.log("Setting threadId=".concat(value, ", this.threadId=").concat(this.threadId)); // Create a new Thread
