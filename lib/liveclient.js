    ...
    value: function _handleConnection(payload) {
      ...
      socket.onerror = function (evt) {
        ...
        switch (socket.readyState) {
          case 0:
            {
              _this9.emit(LiveClient.ERROR, new _exception2.default('Could not connect', 'connection', evt, true));
              break;
            }
          case 1:
            {
              _this9.emit(LiveClient.ERROR, new _exception2.default('Error during socket connection', 'connection', evt));
              break;
            }
          case 2:
            {
              _this9.emit(LiveClient.ERROR, new _exception2.default('Error while closing socket connection', 'connection', evt), true);
              break;
            }
          default:
            {
              _this9.emit(LiveClient.ERROR, new _exception2.default('Unknown error while running socket connection', 'connection', evt), true);
              break;
            }
        }
      };
