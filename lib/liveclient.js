...
function (_EventEmitter) {
  ...
  _createClass(LiveClient, [{
    ...
    value: function send(message) {
      ...
      var msgThreadId = message.threadId; // Set the default

      message.threadId = message.threadId || this.threadId; // Update threadId

      this.log("Updating threadId in send, this.threadId=".concat(this.threadId, ", message.threadId=").concat(message.threadId, ", msgThreadId=").concat(msgThreadId));
    ...
    value: function history(threadId) {
      ...
      var exists = _unique.default.exists({
        clientId: this._clientId,
        key: 'threadId',
    ...
    value: function _reconnect() {
      ...
      this._reconnectTimeout = setTimeout(function () {
        ...
        _this9._openConnection('reconnect');
      }, timeout);
    }
    /**
    ...
    key: "_openConnection",
    value: function _openConnection(source) {
      var _this10 = this;
      ...
      this._rest.get({
        ...
        _this10._handleConnection(result.payload, source);
      }).catch(function (err) {
    ...
    value: function _handleConnection(payload, source) {
      var _this11 = this;
      ...
      socket.onopen = function () {
        ...
        _this11.log("Connection opened source=".concat(source));
      };
      ...
      socket.onmessage = function (evt) {
        ...
        switch (type) {
          ...
          case 'activities.created':
            _this11.log("[ACK] Received message: ".concat(evt.data));
    ...
    set: function set(value) {
      ...
      this.log("Setting threadId=".concat(value, ", this.threadId=").concat(this.threadId, ", stack=").concat(stack)); // Create a new Thread
